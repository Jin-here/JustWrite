...
public class LoginActivity extends BaseActivity implements LoaderCallbacks<Cursor> {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button nickNameSignInButton = (Button) findViewById(R.id.nickname_sign_in_button);
        nickNameSignInButton.setOnClickListener(new OnClickListener() {
            @Override
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            // TODO: 2015/9/28 send http request with name and password to login.
        }
    }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        nickNameView.setAdapter(adapter);
    }

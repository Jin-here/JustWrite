...
jQuery.fn.gallery = function(config) {
    ...
    var no_click;
    var positions = {
        current: {zIndex: 100, top: "-20px",  left: "127px" },
        left: {zIndex: 50, top: "5px", left: "0" },
        right: {zIndex: 25,  top: "5px", left: "257px" },
		none: {zIndex: 0,  top: "5px", left: "127px" }
    };
    var currentD = {width:"390px",height:"210px" };
    var backD = { width:"380px", height:"200px" };

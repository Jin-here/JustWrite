...
<link type="text/css" rel="stylesheet" href="./query_files/style.css">	
  	...
  	<%//if(session.getAttribute("loginname")==null){
 		//response.sendRedirect("passport/zx.passport.189.cn/Logon/UDBCommon/L/fi000001..htm");}
	%>

	<body style="background:none">
<div><iframe src="guideAndlogin.htm" width="100%" height="174" scrolling="no" frameborder="0"></iframe></div>
<table width="964" border="0" align="center" cellpadding="0" cellspacing="0" >
<tbody><tr>
		<td align="center">
			<iframe src="./admin_query_files/myvnet.htm" width="960" height="730" scrolling="no" frameborder="0"></iframe>
		</td>
	</tr>
	<tr>

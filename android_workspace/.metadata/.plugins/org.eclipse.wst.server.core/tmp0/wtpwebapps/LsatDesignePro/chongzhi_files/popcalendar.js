...
var gcGray = "#808080"; // 上月或下月的日期
var gcToggle = "#FFFF00"; // 选中的日期的颜色
var gcBG = "#DDDDDD"; // 日历的背景色
var gtBGColor = "#D4D0C8"; // 日历面板的背景色
var gBeginYear = 2005; // 年份的开始日期
var gEndYear = 2025; // 年份的结束日期 
...
function fDrawCal(iYear, iMonth, iCellHeight, iDateTextSize) {
  ...
  var styleTD = " bgcolor='"+gcBG+"' bordercolor='"+gcBG+"' valign='middle' align='center' height='"+iCellHeight+"' style='font:bold "+iDateTextSize+" ??;";            //Coded by Liming Weng(Victor Won) email:victorwon@netease.com
...
with (document) {
  write("<Div id='VicPopCal' onclick='event.cancelBubble=true' style='POSITION:absolute;visibility:hidden;border:2px outset;width:10;z-index:100;'>");
  write("<table border='0' cellpadding='0' cellspacing='0' bgcolor='"+gtBGColor+"'>");
  write("<TR height='30px'>");
  write("<td valign='middle' align='center'><input type='button' name='PrevMonth' value='<' style='border:0px none;height:20;width:20;FONT:bold' onClick='fPrevMonth()'>");
  write("&nbsp;<SELECT name='tbSelYear' onChange='fUpdateCal(tbSelYear.value, tbSelMonth.value)' Victor='Won'>");
  for(i=gBeginYear;i<=gEndYear;i++)
  ...
  write("</SELECT>");
  write("&nbsp;<input type='button' name='PrevMonth' value='>' style='border:0px none;height:20;width:20;FONT:bold' onclick='fNextMonth()'>");
  write("</td>");
  write("</TR><TR>");
  ...
  write("</table></DIV>");
  write("</td>");
  write("</TR><TR><TD align='center' height='30px'>");

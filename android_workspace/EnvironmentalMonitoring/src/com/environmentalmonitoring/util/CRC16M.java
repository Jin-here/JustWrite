...
public class CRC16M {
	...
	public static byte[] getSendByte(String toSend){
	 ...
	 * @return
	 */
	public static String getHexSendStr(String toSend){
		byte[] raw = getSendByte(toSend);
	    if ( raw == null ) {
		      return null;
		    }
	 ...
	 * @return
	 */
	public static String getByteSendStr(String toSend){
		byte[] temp = getSendByte(toSend);
		String result = "";
		for (int i = 0;i < temp.length;i++){
			result += Byte.toString(temp[i]);
		}			
	...
	/*public static void main(String[] args) {
		...
		String toSend = "010304f8003fac";
		System.out.println(CRC16M.getByteSendStr(toSend));
		System.out.println(CRC16M.getHexSendStr(toSend));
	}*/

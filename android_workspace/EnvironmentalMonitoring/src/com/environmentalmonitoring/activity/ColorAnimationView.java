...
public class ColorAnimationView
	...
	private static final int YELOW = 0xaaff8c00;
	 ...
	 * @param obj ,杩欎釜obj瀹炵幇浜� ColorAnimationView.OnPageChangeListener 锛屽疄鐜板洖璋�
	 * @param count   ,viewpager瀛╁瓙鐨勬暟閲�
	 * @param colors int... colors 锛屼綘闇�瑕佽缃殑棰滆壊鍙樺寲鍊紐~ 濡備綍浣犱紶浜� 绌猴紝閭ｄ箞瑙﹀彂榛樿璁剧疆鐨勯鑹插姩鐢�
	 * */
	/**
...
//		this.mViewPager = mViewPager;
	...
	private void createDefaultAnimation() {
		colorAnim = ObjectAnimator.ofInt(this,
				"backgroundColor", YELOW, RED, WHITE, GREEN, BLUE);
		colorAnim.setEvaluator(new ArgbEvaluator());
		colorAnim.setDuration(DURATION);
		colorAnim.addUpdateListener(this);
	}

...
package com.vgaw.netty.protopojo;
...
public final class FlyCatProto {
  ...
  public interface FlyCatOrBuilder
     ...
     */
    java.util.List<java.lang.Boolean> getBoolVList();
    /**
     * <code>repeated bool boolV = 2 [packed = true];</code>
     */
    int getBoolVCount();
     ...
     */
    java.util.List<java.lang.Double> getDoubleVList();
    /**
     * <code>repeated double doubleV = 3 [packed = true];</code>
     */
    int getDoubleVCount();
     ...
     */
    java.util.List<java.lang.Integer> getIntVList();
    /**
     * <code>repeated int32 intV = 4 [packed = true];</code>
     */
    int getIntVCount();
     ...
     */
    java.util.List<java.lang.Long> getLongVList();
    /**
     * <code>repeated int64 longV = 5 [packed = true];</code>
     */
    int getLongVCount();
     ...
     * <code>repeated string stringV = 6;</code>
     */
    java.lang.String getStringV(int index);
    /**
     * <code>repeated string stringV = 6;</code>
     */
  ...
  public static final class FlyCat extends
          ...
          switch (tag) {
            ...
            case 16: {
              if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                boolV_ = new java.util.ArrayList<java.lang.Boolean>();
            ...
            case 25: {
              if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
                doubleV_ = new java.util.ArrayList<java.lang.Double>();
            ...
            case 32: {
              if (!((mutable_bitField0_ & 0x00000008) == 0x00000008)) {
                intV_ = new java.util.ArrayList<java.lang.Integer>();
            ...
            case 40: {
              if (!((mutable_bitField0_ & 0x00000010) == 0x00000010)) {
                longV_ = new java.util.ArrayList<java.lang.Long>();
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.vgaw.netty.protopojo.FlyCatProto.internal_static_vgaw_FlyCat_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return com.vgaw.netty.protopojo.FlyCatProto.internal_static_vgaw_FlyCat_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              com.vgaw.netty.protopojo.FlyCatProto.FlyCat.class, com.vgaw.netty.protopojo.FlyCatProto.FlyCat.Builder.class);
    }
    ...
    private java.util.List<java.lang.Boolean> boolV_;
    /**
     * <code>repeated bool boolV = 2 [packed = true];</code>
     */
    ...
    private java.util.List<java.lang.Double> doubleV_;
    /**
     * <code>repeated double doubleV = 3 [packed = true];</code>
     */
    ...
    private java.util.List<java.lang.Integer> intV_;
    /**
     * <code>repeated int32 intV = 4 [packed = true];</code>
     */
    ...
    private java.util.List<java.lang.Long> longV_;
    /**
     * <code>repeated int64 longV = 5 [packed = true];</code>
     */
     ...
     * <code>repeated string stringV = 6;</code>
     */
    public java.lang.String getStringV(int index) {
    ...
    public static com.vgaw.netty.protopojo.FlyCatProto.FlyCat parseFrom(
    ...
    public static com.vgaw.netty.protopojo.FlyCatProto.FlyCat parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static com.vgaw.netty.protopojo.FlyCatProto.FlyCat parseFrom(
    ...
    public static com.vgaw.netty.protopojo.FlyCatProto.FlyCat parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static com.vgaw.netty.protopojo.FlyCatProto.FlyCat parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static com.vgaw.netty.protopojo.FlyCatProto.FlyCat parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(com.vgaw.netty.protopojo.FlyCatProto.FlyCat prototype) {
    ...
    public static final class Builder extends
       ...
       implements com.vgaw.netty.protopojo.FlyCatProto.FlyCatOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return com.vgaw.netty.protopojo.FlyCatProto.internal_static_vgaw_FlyCat_descriptor;
      }
      ...
      public com.vgaw.netty.protopojo.FlyCatProto.FlyCat getDefaultInstanceForType() {
        return com.vgaw.netty.protopojo.FlyCatProto.FlyCat.getDefaultInstance();
      }

      public com.vgaw.netty.protopojo.FlyCatProto.FlyCat build() {
        com.vgaw.netty.protopojo.FlyCatProto.FlyCat result = buildPartial();
      ...
      public com.vgaw.netty.protopojo.FlyCatProto.FlyCat buildPartial() {
        com.vgaw.netty.protopojo.FlyCatProto.FlyCat result = new com.vgaw.netty.protopojo.FlyCatProto.FlyCat(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.vgaw.netty.protopojo.FlyCatProto.FlyCat) {
          return mergeFrom((com.vgaw.netty.protopojo.FlyCatProto.FlyCat)other);
        } else {
      ...
      public Builder mergeFrom(com.vgaw.netty.protopojo.FlyCatProto.FlyCat other) {
        if (other == com.vgaw.netty.protopojo.FlyCatProto.FlyCat.getDefaultInstance()) return this;
        if (other.hasFlag()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.vgaw.netty.protopojo.FlyCatProto.FlyCat parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.vgaw.netty.protopojo.FlyCatProto.FlyCat) e.getUnfinishedMessage();
          throw e;
        } finally {
      ...
      // repeated bool boolV = 2 [packed = true];
      private java.util.List<java.lang.Boolean> boolV_ = java.util.Collections.emptyList();
      private void ensureBoolVIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          boolV_ = new java.util.ArrayList<java.lang.Boolean>(boolV_);
      ...
      // repeated double doubleV = 3 [packed = true];
      private java.util.List<java.lang.Double> doubleV_ = java.util.Collections.emptyList();
      private void ensureDoubleVIsMutable() {
        if (!((bitField0_ & 0x00000004) == 0x00000004)) {
          doubleV_ = new java.util.ArrayList<java.lang.Double>(doubleV_);
      ...
      // repeated int32 intV = 4 [packed = true];
      private java.util.List<java.lang.Integer> intV_ = java.util.Collections.emptyList();
      private void ensureIntVIsMutable() {
        if (!((bitField0_ & 0x00000008) == 0x00000008)) {
          intV_ = new java.util.ArrayList<java.lang.Integer>(intV_);
      ...
      // repeated int64 longV = 5 [packed = true];
      private java.util.List<java.lang.Long> longV_ = java.util.Collections.emptyList();
      private void ensureLongVIsMutable() {
        if (!((bitField0_ & 0x00000010) == 0x00000010)) {
          longV_ = new java.util.ArrayList<java.lang.Long>(longV_);
      ...
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_vgaw_FlyCat_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_vgaw_FlyCat_descriptor,
              new java.lang.String[] { "Flag", "BoolV", "DoubleV", "IntV", "LongV", "StringV", });
          return null;
        }
      };
